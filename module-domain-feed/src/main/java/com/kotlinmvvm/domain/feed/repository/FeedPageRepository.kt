 ...
 */
interface FeedPageRepository : CommonRepository<FeedSource, DataResult<FeedPage, FeedLoadError>> {
    /**
     ...
     */
    suspend fun refreshPage(key: FeedSource): DataResult<FeedPage, FeedLoadError>
     ...
     * 没有下一页时，返回当前稳定结果。
     */
    suspend fun loadNextPage(key: FeedSource): DataResult<FeedPage, FeedLoadError>
}
