package com.kt.network.download.utils
...
import com.kt.network.download.utils.PathUtils.getDefaultDownloadDir
...
object PathUtils {
    ...
    internal object ValidationUtils {
        ...
        fun validatePath(context: Context,path: String, allowedBase: String) {
            val normalized = PathUtils.normalizePath(context, path)
