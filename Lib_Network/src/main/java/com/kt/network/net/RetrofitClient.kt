...
import com.kt.network.net.interceptor.Level
import com.kt.network.net.interceptor.LoggingInterceptor
import com.kt.network.net.interceptor.RetryInterceptor
import com.kt.network.net.interceptor.HTTPDNSInterceptor
import com.kt.ktmvvm.lib.BuildConfig
import com.kt.network.net.event.OkHttpEventListener
...
class RetrofitClient private constructor(private val context: Context) {
    ...
    private fun getOrCreateClient(): OkHttpClient {
        return sharedClient ?: synchronized(this) {
            sharedClient ?: createOkHttpClient(false).also { sharedClient = it }
        }
    }
    ...
    private fun createRetrofit(hostType: Int): Retrofit {
